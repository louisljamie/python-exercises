...
fruits_two_or_more_numbers = [number for number in numbers if number > 9 or number < -9]
...
odd_nugative_numbers = [number for number in numbers if number < 0 and number % 2 != 0]
...
primes = [number for number in numbers if number > 1 and all(number % i != 0 for i in range(2, number))]
